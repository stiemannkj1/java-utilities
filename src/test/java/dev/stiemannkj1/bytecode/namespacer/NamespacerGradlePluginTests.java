...
final class NamespacerGradlePluginTests {
  ...
  void test_plugin() throws IOException, InterruptedException {
    ...
    processBuilder
        .environment()
        .put("JAVA_HOME", Require.notEmpty(System.getProperty("java.home"), "java.home property"));

    final ProcessUtils.Result result =
        runWithTimeout(processBuilder, TimeUnit.MINUTES.toMillis(5), TimeUnit.SECONDS.toMillis(10));
